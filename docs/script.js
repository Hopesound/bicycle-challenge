...
const places = [
  ...
  },
  {
    ...
    intro:
      '돈까스 현은 거창한 관광지보다 지역 생활권의 편안함을 보여주는 미식 포인트다. 한 끼 식사와 짧은 휴식을 해결하기 좋아 생활형 자전거 코스의 종착지나 재출발 지점으로 잘 맞는다.',
    nearby: ['효자동 카페거리', '전주시립도서관꽃심', '완산공원'],
    nearbyText:
      '효자동 생활권의 카페와 도서관, 공원 동선이 가까워 식사 후 산책형 코스로 자연스럽게 넘어갈 수 있다.',
    course:
      '효자동 남부 권역을 가볍게 돈 뒤 돈까스 현에서 식사를 마무리하면 생활형 추천 코스로 안내하기 좋다.'
  },
  {
    name: '동물원',
    theme: 'nature',
  ...
  },
  {
    ...
    nearby: ['돈까스 현', '효자동 카페거리', '우석대학교 부속 전주한방병원'],
    nearbyText:
